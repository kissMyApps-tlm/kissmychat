export default {
  ...
  'group.title': 'Group',
  'groupExport.export': 'Export Group',
  'groupExport.exportFailed': 'Failed to export group',
  'groupExport.exportSuccess': 'Group exported successfully',
  'groupExport.exporting': 'Exporting group...',
  'groupExport.import': 'Import Group',
  'groupExport.importFailed': 'Failed to import group',
  'groupExport.importSuccess': 'Group imported successfully',
  'groupExport.importing': 'Importing group...',
  'groupExport.invalidFile': 'Invalid file format. Expected an agent group JSON file.',
